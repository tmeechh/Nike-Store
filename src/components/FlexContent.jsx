    ...
    <>
      ...
      >
        <div className="max-w-lg lg:max-w-none w-full md:text-center grid items-center lg:justify-items-center">
          <h1 className="4-xl sm:text-3xl font-bold text-gradient">
            {heading}
          </h1>
          <h1 className="text-5-xl lg:text-4xl md:text-3-xl sm:text-2-xl font-bold text-slate-900 filter drop-shadow-lg">
            {title}
          </h1>
        ...
        <div className="flex items-center max-w-xl relative lg:max-w-none w-full">
          <img
            src={img}
            alt={`img/${heading}`}
