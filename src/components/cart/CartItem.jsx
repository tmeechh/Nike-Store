      ...
      <div className="flex items-center gap-5">
        ...
        <div className="grid items-center gap-4">
          ...
          <div className="flex items-center justify-around w-full">
            <button
              type="button"
              className={` rounded w-6 h-6 lg:h-5 flex items-center justify-center ${
                cartQuantity === 1 ? 'bg-gray-200 ' : 'text-white bg-theme-cart'
              }`}
            ...
            <button
              type="button"
              className="bg-theme-cart rounded w-6 h-6 lg:h-5 flex items-center justify-center active:scale-90"
      ...
      <div className="grid items-center gap-5">
        ...
        <div className="grid items-center justify-center">
          <button
            ...
            className="cursor-pointer bg-theme-cart rounded p-1 lg:p-0.5 grid items-center justify-items-center"
          >
